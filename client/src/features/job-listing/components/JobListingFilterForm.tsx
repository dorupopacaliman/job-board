...
export const JobListingFilterForm = ({ className, form }: JobListingFilterFormProps) => {
  return (
    <Form {...form}>
      <form className={className} onSubmit={e => e.preventDefault()}>
        <div className="grid gap-4 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3">
          ...
          />
          <JobListingSelectFormField control={form.control} name="type" label="Job Type" options={JOB_LISTING_TYPES} />
    ...
    <FormField
      ...
      render={({ field }) => (
        <FormItem>
          ...
          <Select onValueChange={val => field.onChange(val as PathValue<T, Path<T>>)} value={field.value}>
            <FormControl>
              <SelectTrigger>
                <SelectValue />
              </SelectTrigger>
